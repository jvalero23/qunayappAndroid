...
class HomeListServiceAdapter (private val categorias:ArrayList<Categorias>, private val promocionBanner: PromocionBanner, private var listener:(Categorias)->Unit ):
    ...
    class HomeListServiceAdapterHolder(view: View): RecyclerView.ViewHolder(view){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.service_list_home_holder,parent,false)
        return HomeListServiceAdapterHolder(view)
    }
