...
class TabTwo : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnVerReviews = view.findViewById(R.id.btnVerReviews)  // Inicialización del botón
        ...
        btnVerReviews!!.setOnClickListener {
            // Iniciar la actividad para ver las reseñas
    ...
    fun obtenerData() {
        // Ejemplo de datos, puedes cambiar esto por tus datos reales
